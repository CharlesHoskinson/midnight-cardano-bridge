...
- **[→ The Omega proof](bridges/omega-proof.md)** — genesis-anchored accumulator proving any of the 42 Cardano claims against all epochs; measured per-block circuit K=22 (R1CS) / K=24 (PLONKish). Also as a [formatted PDF](bridges/omega-proof.pdf).
